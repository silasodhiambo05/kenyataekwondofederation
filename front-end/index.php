...
<html lang="en">
  <head>
    ...
    <title>KTF | Web Front-End Login</title>
      ...
      <div id="login-page">
        <div class="container">
              ...
              <form class="form-login" name="login" method="post">
                <h2 class="form-login-heading"><img src="Images/logo.jpg" class="img-circle" style="height:100px;width:100px;"><br><br>Admin Login</h2>
