    ...
    <div class="collapse navbar-collapse" id="myNavbar"  >
      <ul class="nav navbar-nav">
        <li class="active"><a href="index.php" style="color:white;"><span class="glyphicon glyphicon-home"></span> Home</a></li>
          <li class="dropdown">
        <a  href="#" style="color:white;" class="dropbtn"><span class="glyphicon glyphicon-book"></span> Board Members<span class="caret"></span></a>
          <div class="dropdown-content">
              
              <a href="executive.php" style="width:100%;border:none;">Executive Members</a>
              <a href="commitee.php" style="width:100%;border:none;">Commitee Members</a>
              <a href="county_official.php" style="width:100%;">County Officials</a>
              <a href="club_official.php" style="width:100%;">Club Officials</a>
