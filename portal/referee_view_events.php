...
if ($_POST['viewEvents']) {
    ...
    <span class="input-group-addon glyphicon glyphicon-search"></span>
       ...
       <th>Apply</th>
         ...
         <td style="background-color:lightgreen;" ><a href="#?c=<?php echo $eid;?>"><button type='submit' class='btn btn-primary' name='viewPhone'><span class='glyphicon glyphicon-check'></span> Apply</button></a></td>
         </tr>
         </tbody>
