...
<div class="container-fluid">
  <h2 class="btn-info">Referee Registration Panel</h2> 
  <h4>Dear Referee, ensure you go through all the following steps to complete your registration process. <a href="referee_login.php">Back To Login</a></h4> 
</div>
...
<h3>Personal Details</h3>
   ...
   <?php
   include 'referee_registration_data_submission.php'; 
  include 'referee_registration_data.php';
