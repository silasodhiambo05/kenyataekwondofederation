        ...
        if(strlen($num)===3)
        {
          $zero='0';
				...
				(names,gender,county,coach,club,country,dob,pob,pass_number,id_number,phone,dan_number,lincense,email,password) 
				        VALUES ('$names','$gender','$county','$coach','$club','$country','$dob','$pob','$pass_number','$id_number','$phone','$dan','$licence','$email','$pass')";
...
if ($_POST['submit_academics']) {
	?>
			 ...
			 $cgrade=$_POST['cgrade'];
			  ...
			  $sqz=mysqli_query($con,"UPDATE referee SET primary_name='$primary',primary_grade='$pgrade',highschool='$highschool', 	highschool_grade='$hgrade',college='$college',college_grade='$cgrade' WHERE dan_number='$dan_num'");
...
if ($_POST['submit_sports']) {
	?>
			 ...
			 $sqz=mysqli_query($con,"UPDATE referee SET coaching_course='$coaching',master_course='$mastering',psport='$psport',pduration='$pduration',osport='$osport',oduration='$oduration' WHERE dan_number='$dan_num'");
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload1"]["tmp_name"], $target_file)) {
    	...
    	$sqz=mysqli_query($con,"UPDATE referee SET photo='$image1' WHERE `dan_number`='$dan_num'");
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload2"]["tmp_name"], $target_file)) {
    	...
    	$sqz=mysqli_query($con,"UPDATE referee SET birth_cert_image='$image2' WHERE `dan_number`='$dan_num'");
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload3"]["tmp_name"], $target_file)) {
    	...
    	$sqz=mysqli_query($con,"UPDATE referee SET nationalid_image='$image3' WHERE `dan_number`='$dan_num'");
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload4"]["tmp_name"], $target_file)) {
    	...
    	$sqz=mysqli_query($con,"UPDATE referee SET passport_image='$image4' WHERE `dan_number`='$dan_num'");
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload5"]["tmp_name"], $target_file)) {
    	...
    	$sqz=mysqli_query($con,"UPDATE referee SET jobid_image='$image5' WHERE `dan_number`='$dan_num'");
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload6"]["tmp_name"], $target_file)) {
    	...
    	$sqz=mysqli_query($con,"UPDATE referee SET nhif_image='$image6' WHERE `dan_number`='$dan_num'");
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload7"]["tmp_name"], $target_file)) {
    	...
    	$sqz=mysqli_query($con,"UPDATE referee SET secondary_image='$image7' WHERE `dan_number`='$dan_num'");
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload8"]["tmp_name"], $target_file)) {
    	...
    	$sqz=mysqli_query($con,"UPDATE referee SET diploma_image='$image8' WHERE `dan_number`='$dan_num'");
