...
if ($_POST['viewClubProfile']) {
	?>
        ...
        <tr>
        	<td style="font-size:1.5em;color:#286090;">Club Name:</td><td style="font-size:1.3em"><?php echo $club;?></td>
        	</tr>
        	<tr>
        	<td style="font-size:1.5em;color:#286090;">County Location:</td><td style="font-size:1.3em"><?php echo $county;?></td>
        	</tr>
        	<tr>
        	<td style="font-size:1.5em;color:#286090;">Date Registered:</td><td style="font-size:1.3em"><?php echo $date_reg;?></td>
        	</tr>
        	<tr>
        	<td style="font-size:1.5em;color:#286090;">Coach Name:</td><td style="font-size:1.3em"><?php echo $user;?></td>
        	</tr>
        	<tr>
        	<td style="font-size:1.5em;color:#286090;">Total Members:</td><td style="font-size:1.3em"> <?php echo $athletes;?></td>
        	</tr>
        	</table>
        </form>
        <?php
