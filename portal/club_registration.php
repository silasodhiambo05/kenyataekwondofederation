...
if ($_POST['registerClub']) {
	?>
        ...
        <div style="width:100%;text-align:center;">
        	<h3 class="text-center" style="color:maroon;"><span class="glyphicon glyphicon-pencil"></span> Register Your Club/Institution</h3>
        </div>
        <form action="" method="post" id="adduser" class="jumbotron">
            ...
            <div class="input-group ">
            <span class="input-group-addon glyphicon glyphicon-th"></span>
            <input type="text" name="totalAthlete" placeholder="Enter number of Athletes members" class="form-control">
            </div>
            </div>
	...
	?>
       ...
       // $coach=0;
        while($row1=mysqli_fetch_array($results))
          ...
          {
              $sql1 = "INSERT INTO `club` (club_name,county,coach,coach_id,date_registered) VALUES ('$club','$county','$user','$myktf','$date')";
