...
$dan_number= $_SESSION['dan_number'];
    ...
    {
      $sqls="SELECT * FROM  athlete WHERE dan_number='$dan_number'";
...
<h3>Personal Details</h3>
   ...
   <?php
   include 'registration_data_submission_edit.php'; 
  include 'edit_registration_data.php';
  
   ?> 
</div>
<a href="athlete_panel.php">Back Home</a>
</div>
