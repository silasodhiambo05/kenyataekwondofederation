...
<div class="container-fluid">
  <h5 class="btn-success" style="text-align:right;"> <?php echo '.'.$user.' ';?><a href="coach_home_panel.php"><span class="glyphicon glyphicon-off"></span> .</a></h5> 
...
<div class="container-fluid" >
  <div style="background:darkgrey;font-size:1.4em;">
...
<h4 class="btn-warning"><span class="glyphicon glyphicon-info-sign"></span> Are you sure you want to apply for <?php echo $name.', '.$type;?> for your team?</h4>
...
if ($_POST['submit_applications']) {
	?>
                      <script>
                        alert("Sorry! Application as a team not yet ready. Kindly advise your members to apply individually");
                      </script>
