...
if ($_POST['viewAthlete']) {
    ...
    <span class="input-group-addon glyphicon glyphicon-search"></span>
       ...
       <th>More</th>
         ...
         <td style="background-color:lightyellow;" ><a href="athlete_details_to_secretary.php?c=<?php echo $dan_number;?>"><button type='submit' class='btn btn-primary' name='viewPhone'><span class='glyphicon glyphicon-check'></span> View/Approve</button></a></td>
         </tr>
         </tbody>
