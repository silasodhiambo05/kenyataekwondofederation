...
class PDF extends FPDF {
	function Header(){
		...
		$this->Cell(5,5,'',0,0);
		$this->Cell(100,5,'Calendar of events '.$date,0,0);
		$this->Cell(40,5,'',0,1);
		$this->Cell(5,2,'',0,0);
		$this->Cell(100,2,'',0,0);
		$this->Cell(40,2,'',0,1);
		...
		$this->SetDrawColor(50,50,100);
		 ...
		 $this->Cell(100,5,'Event Name.',1,0,'',true);
		
		$this->Cell(45,5,'Venue',1,0,'',true);
...
$no=0;			 
  $sql="SELECT event_id,event_name,event_type,event_venue,event_date FROM events";
	...
	while($row=mysqli_fetch_array($result))
     ...
     $pdf->Cell(25,5,'',0,1);
     $pdf->Cell(25,5,'Total Events',0,0);
