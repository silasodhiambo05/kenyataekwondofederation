...
$id=$_GET['c'];
$sql="SELECT subject,message,email,date_sent FROM public_messages WHERE id='$id'";
...
<div class="col-md-8">
<?php include 'submit_reply_public_function.php';?>
...
<tr>
  <td><b>Sender Email:</b></td><td style="color:#5F3A0E;"><?php echo $email;?></td>
</tr>
<tr>
  <td><b>Date Sent:</b></td><td style="color:#5F3A0E;"><?php echo $date;?></td>
</tr>
