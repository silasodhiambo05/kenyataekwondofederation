...
class PDF extends FPDF {
	function Header(){
		...
		$this->Cell(5,5,'',0,0);
		$this->Cell(100,5,'Registered athletee as at '.$date,0,0);
		$this->Cell(40,5,'',0,1);
		$this->Cell(5,2,'',0,0);
		$this->Cell(100,2,'',0,0);
		$this->Cell(40,2,'',0,1);
...
$sum=0;
$no=0;			 
 $sql =$sql="SELECT names,county,club,id_number,phone,dan_number FROM  athlete";
	...
	while($row=mysqli_fetch_array($result))
	 ...
	 $pdf->Cell(30,5,$dan_number,1,0);
	 $pdf->Cell(50,5,$fname,1,0);
	 
	 $pdf->Cell(25,5,$id_number,1,0);
	 
	 $pdf->Cell(45,5,$club,1,0);
     ...
     $pdf->Cell(25,5,'',0,1);
     $pdf->Cell(25,5,'Total Athlete',0,0);
