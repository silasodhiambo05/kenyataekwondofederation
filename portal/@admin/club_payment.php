...
$count=$_GET['c'];
$sql="SELECT club_id,club_name,county,coach,date_registered FROM club WHERE club_id='$count'";
...
<div class="container-fluid">
  <h2 class="btn-info" style="text-align:center;"><a href="@admin_@panel_@manage.php" style="float:left;color:white">Back Home</a>Club Payment Panel <img id="logo1" src="Images/cash2.jpg" class="img-circle" style="width:30px;height:30px;"></h2> 
...
<tr>
  <td><b>Club Name:</b></td><td style="color:#5F3A0E;"><?php echo $name;?></td>
</tr>
<tr>
  <td><b>Club Coach:</b></td><td style="color:#5F3A0E;"><?php echo $coach;?></td>
</tr>
...
<div class="col-md-10">
<?php
include 'club_payment_function.php'; 
?>
<form action="" method="POST"  style="font-size:1.5em;">
Amount Paid (Kshs.):
<input style="height:50px;font-size:2em;" type="number" name="amountPaid" placeholder="0.0" class="form-control" required="">
<br>
Payment Ref. Number
<input style="height:50px;font-size:2em;" type="text" name="refNumber" placeholder="" class="form-control" required="">
<br>
