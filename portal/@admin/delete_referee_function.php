...
$count=$_GET['c'];
$sql="SELECT name,national_id,ktf_number,phone,email FROM referee WHERE id='$count'";
...
<div class="container-fluid">
  <h2 class="btn-info" style="text-align:center;"><a href="@admin_@panel_@manage.php" style="float:left;color:white"><span class="glyphicon glyphicon-home"></span> Back Home</a>Delete Referee  <span class="glyphicon glyphicon-question-sign"></span></h2> 
...
<div class="col-md-8">
<h3 class="btn-danger"><span class="fa fa-warning"></span> Warning!! You are about to permanently delete the following Referee</h3>
...
<div class="col-md-10">
<?php
if ($_POST['submit_delete_referee']) {
$sql = "DELETE FROM referee WHERE id='$count'";
...
<br>
<input type="submit" name="submit_delete_referee" value="Yes, Delete" class="btn btn-danger">
<input type="submit" name="cancel_delet_referee" value="No, Do not Delete" class="btn btn-primary" style="float:right;">
