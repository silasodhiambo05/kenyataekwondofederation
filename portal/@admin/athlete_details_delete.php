...
<div class="col-md-1" id="rightlogo">
    <img id="logo1" src="Images/wt3.png" class="img-circle" style="width:100px;height:100px;">
</div>
</div>
</div>
<div class="container-fluid">
  <h2 class="btn-info" style="text-align:center;"><a href="@admin_@panel_@manage.php" style="float:left;color:white"><span class="glyphicon glyphicon-home"></span> Back Home</a>Delete Athlete  <span class="glyphicon glyphicon-question-sign"></span></h2> 
...
<div class="col-md-8">
<h3 class="btn-danger"><span class="fa fa-warning"></span> Warning!! You are about to permanently delete the following athletee</h3>
...
<div class="col-md-10">
<?php
if ($_POST['submit_delete_athlete']) {
$sql = "DELETE FROM athlete WHERE id='$count'";
...
if ($_POST['cancel_delet_athlete']) {
  header("location: @admin_@panel_@manage.php");
}
?>
<form action="" method="POST">
<br>
<input type="submit" name="submit_delete_athlete" value="Yes, Delete" class="btn btn-danger">
<input type="submit" name="cancel_delet_athlete" value="No, Do not Delete" class="btn btn-primary" style="float:right;">
