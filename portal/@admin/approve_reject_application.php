...
$count1=$_GET['c'];
$sql="SELECT event_id,ktf_number,applicant_name,date_applied FROM events_application WHERE id='$count1'";
    ...
    $sql="SELECT event_name,event_type,event_venue,event_date FROM events WHERE event_id='$count'";
                  $result=mysqli_query($con,$sql) or die(mysql_error());
                  while($row=mysqli_fetch_array($result))
                   {   
   ...
   $sql="SELECT * FROM  athlete WHERE dan_number='$ktf'";
                  $result=mysqli_query($con,$sql) or die(mysql_error());
...
<div class="container-fluid">
  <h3 class="btn-info"><?php echo 'Check the details of '.$name.', Before approval to participate in '.$event_name.', '.$event_type;?></h3> 
...
<div class="col-md-4 well" >
  ...
  <?php echo '<tr><img src="photograph/'.$personal_photo.'" class="img-circle" style="height:100px;width:100px;"></tr>';?>
    <tr>
      <td><b>Dan Number:</b></td><td><?php echo $ktf;?></td>
    </tr>
    <tr>
...
<h5>Birth Certificate</h5>
  <?php echo '<tr><img src="birth_cert/'.$birth.'"  style="height:150px;width:150px;"></tr>';?>
</div>
<div class="col-md-3">
<h5>National ID</h5>
  <?php echo '<tr><img src="national_id/'.$id.'" style="height:150px;width:150px;""></tr>';?>
</div>
<div class="col-md-3">
<h5>Passport</h5>
  <?php echo '<tr><img src="passport/'.$passport.'" style="height:150px;width:150px;"></tr>';?>
</div>
<div class="col-md-3">
<h5>Student/Job ID</h5>
  <?php echo '<tr><img src="job_id/'.$st_id.'" style="height:150px;width:150px;"></tr>';?>
</div>
</div>
<div class="container-fluid well">
<div class="col-md-3">
<h5>NHIF Card</h5>
  <?php echo '<tr><img src="NHIF/'.$nhif.'" style="height:150px;width:150px;"></tr>';?>
</div>
<div class="col-md-3">
<h5>High School Certificate</h5>
  <?php echo '<tr><img src="Highschool_cert/'.$sec_cert.'" style="height:150px;width:150px;"></tr>';?>
</div>
<div class="col-md-3">
<h5>Higher Education Certificate</h5>
  <?php echo '<tr><img src="diploma_cert/'.$dip_cert.'" style="height:150px;width:150px;"></tr>';?>
</div>
<div class="col-md-3">
...
<h4>Participation for <?php echo $event_name;?></h4>
<div class="form-group">
Comment(If you reject this application, give reason here)
<div class="input-group ">
 <span class="input-group-addon glyphicon glyphicon-pencil"></span>
<textarea class="form-control" name="approval_comment"></textarea>
</div>
</div>
<input type="submit" name="submit_apprval" value="Approve" class="btn btn-success">
<input type="submit" name="submit_rejection" value="Reject" class="btn btn-danger">
</div>
<?php
if ($_POST['submit_rejection']) {
  $Comment=$_POST['approval_comment'];
  if (empty($Comment)===true) {
    ?>
    <script>
      alert("Error, You must give reason for rejecting this application");
    </script>
    <?php
  ...
  {
    $sqz=mysqli_query($con,"UPDATE events_application SET status='Rejected',comment='$Comment' WHERE event_id='$count' AND ktf_number='$ktf'");
  header("location: @admin_@panel_@manage.php");
}
}
if ($_POST['submit_apprval']) {
  $Comment=$_POST['approval_comment'];
  $sqz=mysqli_query($con,"UPDATE events_application SET status='Approved',comment='$Comment' WHERE event_id='$count' AND ktf_number='$ktf'");
