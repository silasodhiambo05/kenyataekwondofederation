...
$count=$_GET['c'];
   $sql="SELECT * FROM  athlete WHERE dan_number='$count'";
...
<div class="container-fluid">
  <h2 class="btn-info" style="text-align:center;">Athletes Details<br>Check the details and approve if satisfied</h2> 
...
<div class="col-md-4 well" >
  ...
  <?php echo '<tr><img src="photograph/'.$personal_photo.'" class="img-circle" style="height:100px;width:100px;"></tr>';?>
    <tr>
      <td><b>KTF Number:</b></td><td><?php echo $count;?></td>
    </tr>
    <tr>
