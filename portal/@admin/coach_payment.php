...
$count=$_GET['c'];
$sql="SELECT names,id_number,dan_number,phone,email,password FROM coach WHERE id='$count'";
...
<div class="container-fluid">
  <h2 class="btn-info" style="text-align:center;"><a href="@admin_@panel_@manage.php" style="float:left;color:white">Back Home</a>Coach Payment Panel <img id="logo1" src="Images/cash2.jpg" class="img-circle" style="width:30px;height:30px;"></h2> 
...
<tr>
  <td><b>Coach Name:</b></td><td style="color:#5F3A0E;"><?php echo $name;?></td>
</tr>
<tr>
...
<div class="col-md-10">
<?php
include 'coach_payment_function.php'; 
?>
