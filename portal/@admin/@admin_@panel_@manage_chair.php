...
<h4>Administration Panel (CHAIRPERSON)</h4>
...
<form action="" method="POST">
<input type="submit" class="btn btn-primary" name="activateAccount" style="width:100%;margin-bottom:2px;" value="Activate Athlete Account" >
<input type="submit" class="btn btn-primary" name="activate_coach_account" style="width:100%;margin-bottom:2px;" value="Activate Coach Activate" >
<input type="submit" class="btn btn-primary" name="activate_referee_account" style="width:100%;margin-bottom:2px;" value="Activate Referee Account" >
