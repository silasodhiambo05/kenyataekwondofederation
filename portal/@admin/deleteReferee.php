<?php
if ($_POST['deleteReferee']) {
	?>
        <script>
        	document.getElementById("magement_panel").innerHTML="";
        </script>
        <?php
        $sql="SELECT id,name,national_id,phone,email FROM referee";
    ...
    <span class="input-group-addon glyphicon glyphicon-search"></span>
       ...
       <th>More</th>
         ...
         <td style="background-color:lightyellow;" ><a href="delete_referee_function.php?c=<?php echo $idn;?>"><button type='submit' class='btn btn-danger' name='viewPhone'><span class='glyphicon glyphicon-remove'></span> </button></a></td>
         </tr>
         </tbody>
