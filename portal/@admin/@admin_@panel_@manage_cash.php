...
<h4>Administration Panel (TREASURY)</h4>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown" style="color:red;" >
          ...
          <form action="" method="post">
             ...
             <li><input type="submit" class="btn" name="activateAccount" value="Acknowlege Payment" style="width:100%;border:none;"></li>
        ...
        <li class="dropdown" style="color:red;" >
          ...
          <li><input type="submit" class="btn" name="activate_coach_account" value="Acknowlege Payment" style="width:100%;border:none;"></li>
        ...
        <li class="dropdown" style="color:red;" >
          ...
          <li><input type="submit" class="btn" name="activate_referee_account" value="Acknowlege Payment" style="width:100%;border:none;"></li>
        ...
        <li class="dropdown" style="color:red;" >
          ...
          <ul class="dropdown-menu">
          <form action="" method="post">
          <li><input type="submit" class="btn" name="activateClub" value="Accept Clubs Payment" style="width:100%;border:none;"></li>
...
<form action="" method="POST">
<input type="submit" class="btn btn-primary" name="activateAccount" style="width:100%;margin-bottom:2px;" value="Athlete Payment" >
<input type="submit" class="btn btn-primary" name="activate_coach_account" style="width:100%;margin-bottom:2px;" value="Coach Payment" >
<input type="submit" class="btn btn-primary" name="activate_referee_account" style="width:100%;margin-bottom:2px;" value="Referee Payment" >
